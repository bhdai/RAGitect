...
class TestCitationMetadata:
    ...
    def test_similarity_bounds(self):
        ...
        # Valid bounds
        CitationMetadata(chunk_index=0, similarity=0.0, preview="test")
        CitationMetadata(chunk_index=0, similarity=1.0, preview="test")
        CitationMetadata(chunk_index=0, similarity=0.5, preview="test")

        # Invalid bounds
        with pytest.raises(ValueError):
            CitationMetadata(chunk_index=0, similarity=-0.1, preview="test")

        with pytest.raises(ValueError):
            CitationMetadata(chunk_index=0, similarity=1.1, preview="test")
    ...
    def test_preview_accepts_long_content(self):
        ...
        metadata = CitationMetadata(chunk_index=0, similarity=0.5, preview=long_text)
...
class TestCitation:
    ...
    def test_serialization_camel_case(self):
        ...
        citation = Citation(
            ...
            title="test.pdf",
            provider_metadata={"ragitect": {"chunkIndex": 0}},
        )
